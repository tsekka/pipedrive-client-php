...
{
    /**
     * @var StagesController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return StagesController The *Singleton* instance.
     */
     ...
     * @param  array  $options    Array with all options for search
     * @param integer $options['id']        ID of the stage
     * @param integer $options['filterId']  (optional) If supplied, only deals matching the given filter will be
     *                                      returned.
     * @param integer $options['userId']    (optional) If supplied, filter_id will not be considered and only deals
     *                                      owned by the given user will be returned. If omitted, deals owned by the
     *                                      authorized user will be returned.
     * @param int     $options['everyone']  (optional) If supplied, filter_id and user_id will not be considered –
